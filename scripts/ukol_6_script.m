...
Fz_sin = tf([sin(T) 0], [1 2*cos(T) 1], 0.2); % diskrétní pøenos sin(x)
discrete_Fs; % diskrétní pøenos urèený v úkolu 1)
...
% ruènì pøepsaná soustava rovnic do maticového tvaru
...
Fr_6 = tf([d3 d2 d1 d0], [1 -c0-1.96 1+1.96*c0 -c0], 0.2); % výsledný pøenos regulátoru
