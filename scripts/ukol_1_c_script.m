...
% Dopøedná obdélníková aproximace - spoèteno na papír substitucí: s -> (z - 1)/T
Fs_obdelnik = tf(7.2, [25 -48.2 24.64], T);
...
figure
impulse(Fs, Fs_nulty_rad,Fs_obdelnik,Fs_lichobeznik,Fs_exact, 20)
...
figure
step(Fs, Fs_nulty_rad,Fs_obdelnik,Fs_lichobeznik,Fs_exact, 20)
legend('puvodni prenos', 'tvarovac nulteho radu', 'dopredna obdelnikova aproximace', 'lichobeznikova aproximace', 'exaktni prevod nul a polu')
title('Porovnani prechodovych charakteristik')

% GMK
figure
rlocus(Fs, Fs_nulty_rad,Fs_obdelnik,Fs_lichobeznik,Fs_exact)
legend('puvodni prenos', 'tvarovac nulteho radu', 'dopredna obdelnikova aproximace', 'lichobeznikova aproximace', 'exaktni prevod nul a polu')
title('Porovnani GMK')