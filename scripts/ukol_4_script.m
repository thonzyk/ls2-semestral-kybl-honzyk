...
Fs_4_1 = (alpha * kompenzacni_polynom * b_p)/(b_p * d_p + a_p * c_p);
Fs_4_citlivostni_1 = (a_p * c_p)/(a_p * c_p + b_p * d_p);
...
Fs_4_2 = (alpha * kompenzacni_polynom * b_p)/(b_p * d_p + a_p * c_p);
Fs_4_citlivostni_2 = (a_p * c_p)/(a_p * c_p + b_p * d_p);
